        ...
        if (!self.floatingMode) {
            switch (self.transitionCoordinator.representingScope) {
                case FSCalendarScopeMonth: {
                    ...
                    _daysContainer.frame = CGRectMake(0, headerHeight, self.fs_width, currentHeight);
...
//                    _daysContainer.frame = CGRectMake(0, headerHeight+weekdayHeight, self.fs_width, contentHeight); //vikas43
                    _daysContainer.frame = CGRectMake(0, headerHeight, self.fs_width, contentHeight);
                    _collectionView.frame = CGRectMake(0, 0, _daysContainer.fs_width, contentHeight);
                    break;
                }
            }
...
- (void)invalidateLayout
{
    if (!self.floatingMode) {
        ...
        if (_calendarHeaderView) { //!_calendarHeaderView vikas
